...
**Release to cite for the revised manuscript:** tag `v1.0.0-reproducibility`,
...
|---|---|---|
| Stage 2 LoRA adapter used for the manuscript | **absent** from every accessible project location; not a licensing restriction | the exact configuration, the training script, the loader, the validator, and an explicit statement (`artifacts/lora/README.md`) |
